...
import '../styles/LatencySensorGraph.css';

function LatencySensorGraph({ data, selectedRange, onRangeChange }) {
  const ranges = ['Last 3 hours', 'Last 24 hours', 'Last 7 days', 'Last 30 days'];

  return (
    <div className="latency-sensor-graph sensor-graph">
...
export default LatencySensorGraph;
